...
public final class PdfText2Html$ implements Loggable {
    ...
    public void convert(final SeekableSource in, final File outputFile, final boolean withImages, final int maxImagesPerDocument, final boolean resizeImages, final int maxPagesPerDocument, final boolean withToc, final Option<String> fallbackTitle, final boolean removeOverflowHyphenatedWords, final int maxImageWidth, final int maxImageHeight, final Option<String> password) throws IOException {
