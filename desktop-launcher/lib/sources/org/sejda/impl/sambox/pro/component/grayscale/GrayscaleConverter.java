...
public class GrayscaleConverter extends PDFStreamEngine {
    ...
    public GrayscaleConverter(ContentStreamWriterStack writers, boolean convertImages, boolean convertTextToBlack, boolean compressImages) {
        ...
        addOperator(new ConvertToGraySetColor(new SetStrokingColor(), Operator.getOperator(OperatorName.STROKING_COLOR)));
        addOperator(new ConvertToGraySetColor(new SetNonStrokingColor(), Operator.getOperator(OperatorName.NON_STROKING_COLOR)));
        addOperator(new ConvertToGraySetColor(new SetStrokingColorN(), Operator.getOperator(OperatorName.STROKING_COLOR_N)));
        addOperator(new ConvertToGraySetColor(new SetNonStrokingColorN(), Operator.getOperator(OperatorName.NON_STROKING_COLOR_N)));
        addOperator(new ConvertToGraySetColor(new SetStrokingDeviceRGBColor(), Operator.getOperator(OperatorName.STROKING_COLOR_GRAY)));
        addOperator(new ConvertToGraySetColor(new SetNonStrokingDeviceRGBColor(), Operator.getOperator(OperatorName.NON_STROKING_GRAY)));
        addOperator(new ConvertToGraySetColor(new SetStrokingDeviceCMYKColor(), Operator.getOperator(OperatorName.STROKING_COLOR_GRAY)));
        addOperator(new ConvertToGraySetColor(new SetNonStrokingDeviceCMYKColor(), Operator.getOperator(OperatorName.NON_STROKING_GRAY)));
    }
    ...
    public void processPage(PDPage page) throws IOException {
        ...
        try {
            ...
            page.getCOSObject().setItem(COSName.CONTENTS, (COSBase) stream);
        } finally {
    ...
    private class XObjectOperator extends OperatorProcessor {
        ...
        public void process(Operator operator, List<COSBase> operands) throws IOException {
            ...
            if (operand instanceof COSName) {
                ...
                COSBase existing = (COSBase) Optional.ofNullable((COSDictionary) getContext().getResources().getCOSObject().getDictionaryObject(COSName.XOBJECT, COSDictionary.class)).map(d -> {
                ...
                if (existing instanceof COSStream) {
                    if (!(existing instanceof ReadOnlyFilteredCOSStream)) {
                        ...
                        if (!GrayscaleUtils.isGray(stream)) {
                            try {
                ...
                GrayscaleConverter.LOG.warn("Unexpected type {} for xObject {}", existing.getClass(), objectName.getName());
            }
        }
        ...
        private ReadOnlyFilteredCOSStream convertToGrayscale(COSName objectName, PDImageXObject image, IndirectCOSObjectIdentifier id, boolean shouldCompress) throws IOException {
            ...
            if (Objects.isNull(convertedImage)) {
                if (shouldCompress) {
                    ...
                    if (Optional.ofNullable((COSStream) image.getCOSObject().getDictionaryObject(COSName.SMASK, COSStream.class)).map(sm -> {
                        return (COSArray) sm.getDictionaryObject(COSName.MATTE, COSArray.class);
                    }).isPresent()) {
        ...
        private void setXObject(COSName objectName, ReadOnlyFilteredCOSStream stream) {
            ...
            xobjects.setItem(objectName, (COSBase) stream);
        }
    ...
    private static ReadOnlyFilteredCOSStream readOnlyStreamForImage(COSStream existing, PDImageXObject original) throws IOException {
        ...
        COSStream sm = (COSStream) original.getCOSObject().getDictionaryObject(COSName.SMASK, COSStream.class);
        if (Objects.nonNull(sm)) {
            COSArray matte = (COSArray) sm.getDictionaryObject(COSName.MATTE, COSArray.class);
            if (Objects.nonNull(matte)) {
                PDColor color = new PDColor(matte, original.getColorSpace());
                COSDictionary newSmDic = sm.duplicate();
                newSmDic.setItem(COSName.MATTE, (COSBase) new COSArray(new COSFloat(GrayscaleUtils.toGray(original.getColorSpace().toRGB(color.getComponents())))));
                COSName cOSName = COSName.SMASK;
                Objects.requireNonNull(sm);
                stream.setItem(cOSName, new ReadOnlyFilteredCOSStream(newSmDic, (ReadOnlyFilteredCOSStream.InputStreamSupplier<InputStream>) sm::getFilteredStream, sm.getFilteredLength()));
            } else {
                stream.setItem(COSName.SMASK, (COSBase) sm);
            }
        }
        ...
        ContentStreamWritingOperator(OperatorProcessor delegate) {
            ...
            /*  JADX ERROR: Method code generation error
                jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x000d: CONSTRUCTOR 
                 ...
                 A[MD:(org.sejda.sambox.contentstream.operator.OperatorProcessor, org.sejda.sambox.contentstream.operator.OperatorConsumer):void (m)] (LINE:319) call: org.sejda.sambox.contentstream.operator.OperatorProcessorDecorator.<init>(org.sejda.sambox.contentstream.operator.OperatorProcessor, org.sejda.sambox.contentstream.operator.OperatorConsumer):void type: SUPER in method: org.sejda.impl.sambox.pro.component.grayscale.GrayscaleConverter.ContentStreamWritingOperator.<init>(org.sejda.impl.sambox.pro.component.grayscale.GrayscaleConverter, org.sejda.sambox.contentstream.operator.OperatorProcessor):void, file: org.sejda.sejda-sambox-pro-5.1.10.1.jar:org/sejda/impl/sambox/pro/component/grayscale/GrayscaleConverter$ContentStreamWritingOperator.class
        ...
        ConvertToGraySetColor(SetColor d, Operator replace) {
            ...
            /*  JADX ERROR: Method code generation error
                jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x000f: CONSTRUCTOR 
                 ...
                 A[MD:(org.sejda.sambox.contentstream.operator.OperatorProcessor, org.sejda.sambox.contentstream.operator.OperatorConsumer):void (m)] (LINE:354) call: org.sejda.sambox.contentstream.operator.OperatorProcessorDecorator.<init>(org.sejda.sambox.contentstream.operator.OperatorProcessor, org.sejda.sambox.contentstream.operator.OperatorConsumer):void type: SUPER in method: org.sejda.impl.sambox.pro.component.grayscale.GrayscaleConverter.ConvertToGraySetColor.<init>(org.sejda.impl.sambox.pro.component.grayscale.GrayscaleConverter, org.sejda.sambox.contentstream.operator.color.SetColor, org.sejda.sambox.contentstream.operator.Operator):void, file: org.sejda.sejda-sambox-pro-5.1.10.1.jar:org/sejda/impl/sambox/pro/component/grayscale/GrayscaleConverter$ConvertToGraySetColor.class
                	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:310)
                	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:273)
                	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:94)
                	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
    ...
    private PDAnnotation processAnnotation(PDAnnotation annotation) {
        ...
        try {
            ...
            COSDictionary ap = (COSDictionary) annotation.getCOSObject().getDictionaryObject(COSName.AP, COSDictionary.class);
            if (Objects.nonNull(ap)) {
                ...
                annotation.getCOSObject().setItem(COSName.AP, (COSBase) toAP);
            }
        } catch (Exception e) {
    ...
    private void processAnnotationColor(COSName key, PDAnnotation annotation) {
        Optional.ofNullable(annotation.getColor(key)).ifPresent(c -> {
            try {
                annotation.getCOSObject().setItem(key, (COSBase) new COSArray(new COSFloat(toBlackOrGray(c.getColorSpace().toRGB(c.getComponents())))));
            } catch (Exception e) {
    ...
    private void processAppearanceStreamOrDictionary(PDAnnotation annotation, COSName key, COSBase entry, COSDictionary toAP) {
        if (Objects.nonNull(entry)) {
            ...
            for (Map.Entry<COSName, PDAppearanceStream> subEntry : streamOrDic.getSubDictionary().entrySet()) {
                sub.setItem(subEntry.getKey(), (COSBase) processAppearance(annotation, subEntry.getValue()));
            }
            toAP.setItem(key, (COSBase) sub);
        }
    }
