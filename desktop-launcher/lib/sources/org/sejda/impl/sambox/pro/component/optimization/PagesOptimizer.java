...
public class PagesOptimizer implements Consumer<PDPage> {
    ...
    private void tilingPatternOperators(ContentStreamOptimizer csOptimizer) {
        ...
        csOptimizer.addOperatorIfAbsent(new ResourcesHitter.TilingPatternHitterSetStrokingColor(OperatorName.STROKING_COLOR_N));
        csOptimizer.addOperatorIfAbsent(new ResourcesHitter.TilingPatternHitterSetNonStrokingColor(OperatorName.NON_STROKING_COLOR_N));
    }
