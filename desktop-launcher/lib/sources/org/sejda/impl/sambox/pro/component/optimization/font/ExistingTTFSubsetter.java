...
/* loaded from: org.sejda.sejda-sambox-pro-5.1.10.1.jar:org/sejda/impl/sambox/pro/component/optimization/font/ExistingTTFSubsetter.class */
class ExistingTTFSubsetter extends BaseTTFSubsetter {
    public ExistingTTFSubsetter(COSDictionary existingFont, COSStream fontFileStream, TrueTypeFont font) throws IOException {
        super(existingFont, fontFileStream, font);
    }

    @Override // org.sejda.sambox.pdmodel.font.BaseTTFSubsetter
    public COSStream doSubset(String subsetFontName) throws IOException {
        int numberOfGlyphs = Math.min(getGlyphIds().last().intValue(), getFont().getNumberOfGlyphs());
        ...
        try {
            ...
            tables.put("cmap", buildCMapTable());
            tables.put("OS/2", buildOS2Table());
            String[] keepTables = {"prep", "cvt ", "fpgm"};
