...
public class PageToFormXObject {
    ...
    private PDStream getStream(PDPage page) throws IOException {
        ...
        if (base instanceof COSStream) {
            ...
            return new PDStream(new ReadOnlyFilteredCOSStream(cOSDictionaryDuplicate, (ReadOnlyFilteredCOSStream.InputStreamSupplier<InputStream>) existing::getFilteredStream, existing.getFilteredLength()));
        }
