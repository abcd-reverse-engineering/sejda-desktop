...
public class PdfWatermarker {
    ...
    public void mark(PDPage page) throws TaskIOException {
        ...
        if (this.watermark.getLocation() == Location.BEHIND) {
            this.imageWriter.prepend(page, this.form, (Point2D) page.cropBoxCoordinatesToDraw(this.watermark.getPosition()), 1.0f, 1.0f, gs, page.getRotation());
        } else {
            this.imageWriter.append(page, this.form, (Point2D) page.cropBoxCoordinatesToDraw(this.watermark.getPosition()), 1.0f, 1.0f, gs, page.getRotation());
        }
    }
}
