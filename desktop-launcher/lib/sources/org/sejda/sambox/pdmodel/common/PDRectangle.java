...
/* loaded from: org.sejda.sambox-3.0.24.jar:org/sejda/sambox/pdmodel/common/PDRectangle.class */
public class PDRectangle implements COSObjectable {
    ...
    public PDRectangle(Rectangle2D rectange) {
        this((float) rectange.getX(), (float) rectange.getY(), (float) rectange.getWidth(), (float) rectange.getHeight());
    }
    ...
    public boolean equals(Object o) {
        ...
        PDRectangle rectangle = (PDRectangle) o;
        return this.rectArray.equals(rectangle.rectArray);
    }

    public int hashCode() {
        return this.rectArray.hashCode();
    }
    ...
    public static PDRectangle rectangleFrom(COSArray array) {
        if (Objects.nonNull(array) && array.size() >= 4) {
