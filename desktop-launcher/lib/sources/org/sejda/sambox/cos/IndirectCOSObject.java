...
/* loaded from: org.sejda.sambox-3.0.24.jar:org/sejda/sambox/cos/IndirectCOSObject.class */
public class IndirectCOSObject extends COSBase {
    ...
    public static IndirectCOSObject asIndirectObject(COSObjectable wrapped) {
        return new IndirectCOSObject(((COSObjectable) Optional.ofNullable(wrapped).orElse(COSNull.NULL)).getCOSObject());
    }
}
