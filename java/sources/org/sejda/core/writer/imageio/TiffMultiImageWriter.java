...
/* loaded from: org.sejda.sejda-image-writers-5.1.10.jar:org/sejda/core/writer/imageio/TiffMultiImageWriter.class */
public class TiffMultiImageWriter extends MultiImageWriter<PdfToSingleTiffParameters> {
    @Override // org.sejda.core.writer.imageio.MultiImageWriter, org.sejda.core.writer.model.ImageWriter
    public /* bridge */ /* synthetic */ boolean supportMultiImage() {
        return super.supportMultiImage();
    }

    @Override // org.sejda.core.writer.imageio.MultiImageWriter, org.sejda.core.writer.imageio.AbstractImageWriter, org.sejda.core.writer.model.ImageWriter
    ...
    @Override // org.sejda.core.writer.imageio.AbstractImageWriter
    public ImageWriteParam newImageWriterParams(PdfToSingleTiffParameters params) {
