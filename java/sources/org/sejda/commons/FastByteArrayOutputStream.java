...
/* loaded from: org.sejda.sejda-commons-3.0.0.jar:org/sejda/commons/FastByteArrayOutputStream.class */
public class FastByteArrayOutputStream extends OutputStream {
    private static final int DEFAULT_BLOCK_SIZE = 256;
    private static final int MAX_BLOCK_SIZE = 134217728;
    ...
    public FastByteArrayOutputStream(int initialBlockSize) {
        ...
        this.index = 0;
        this.closed = false;
        assertIsTrue(Boolean.valueOf(initialBlockSize > 0), "Initial block size must be greater than 0");
    ...
    public void write(int datum) throws IOException {
        RequireUtils.requireIOCondition(!this.closed, "Stream closed");
    ...
    public void resize(int targetCapacity) {
        assertIsTrue(Boolean.valueOf(targetCapacity >= size()), "New capacity must not be smaller than current size");
    ...
    private void addBuffer(int minCapacity) {
        ...
        this.nextBlockSize = Math.min(MAX_BLOCK_SIZE, this.nextBlockSize * 2);
    }
    ...
    /* loaded from: org.sejda.sejda-commons-3.0.0.jar:org/sejda/commons/FastByteArrayOutputStream$FastByteArrayInputStream.class */
