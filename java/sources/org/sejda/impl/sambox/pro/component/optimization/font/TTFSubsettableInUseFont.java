...
public class TTFSubsettableInUseFont extends SubsettableInUseFont {
    ...
    public void subset() {
        ...
        if (Objects.nonNull(subsettedStream)) {
            COSDictionary descriptor = ((COSDictionary) getDictionaryObject(COSName.FONT_DESC, COSDictionary.class)).duplicate();
            try {
                ...
                setItem(COSName.FONT_DESC, (COSBase) descriptor);
            } catch (IOException e) {
