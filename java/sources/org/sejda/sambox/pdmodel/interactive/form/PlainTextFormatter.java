...
/* loaded from: org.sejda.sambox-3.0.24.jar:org/sejda/sambox/pdmodel/interactive/form/PlainTextFormatter.class */
class PlainTextFormatter {
    ...
    /* loaded from: org.sejda.sambox-3.0.24.jar:org/sejda/sambox/pdmodel/interactive/form/PlainTextFormatter$TextAlign.class */
    enum TextAlign {
        LEFT(0),
        CENTER(1),
        RIGHT(2),
    ...
    /* loaded from: org.sejda.sambox-3.0.24.jar:org/sejda/sambox/pdmodel/interactive/form/PlainTextFormatter$Builder.class */
    ...
    public void format() throws IOException {
        if (this.textContent != null && !this.textContent.getParagraphs().isEmpty()) {
            ...
            this.contents.setFont(this.appearanceStyle.getFont(), this.appearanceStyle.getFontSize());
