...
/* loaded from: org.sejda.sambox-3.0.24.jar:org/sejda/sambox/pdmodel/interactive/annotation/handlers/PDTextAppearanceHandler.class */
public class PDTextAppearanceHandler extends PDAbstractAppearanceHandler {
    ...
    private void drawNewParagraph(PDAnnotationText annotation, PDAppearanceContentStream contentStream) throws IOException {
        ...
        addPath(contentStream, PDType1Font.HELVETICA_BOLD().getPath(PDAnnotationLink.HIGHLIGHT_MODE_NONE));
