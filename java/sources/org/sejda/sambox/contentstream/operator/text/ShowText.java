...
/* loaded from: org.sejda.sambox-3.0.24.jar:org/sejda/sambox/contentstream/operator/text/ShowText.class */
public class ShowText extends OperatorProcessor {
    @Override // org.sejda.sambox.contentstream.operator.OperatorProcessor
    public void process(Operator operator, List<COSBase> arguments) throws IOException {
        if (!arguments.isEmpty()) {
            COSBase base = arguments.get(0);
            if ((base instanceof COSString) && Objects.nonNull(getContext().getTextMatrix())) {
