...
/* loaded from: org.sejda.sambox-3.0.24.jar:org/sejda/sambox/contentstream/operator/text/SetCharSpacing.class */
public class SetCharSpacing extends OperatorProcessor {
    ...
    public void process(Operator operator, List<COSBase> arguments) throws IOException {
        ...
        if (charSpacing instanceof COSNumber) {
            ...
            getContext().getGraphicsState().getTextState().setCharacterSpacing(characterSpacing.floatValue());
        }
    }
