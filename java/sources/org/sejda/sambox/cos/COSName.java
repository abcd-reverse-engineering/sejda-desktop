...
import org.sejda.sambox.pdmodel.encryption.StandardSecurityHandler;
...
import org.sejda.sambox.pdmodel.interactive.measurement.PDMeasureDictionary;
import org.sejda.sambox.pdmodel.interactive.measurement.PDNumberFormatDictionary;
import org.sejda.sambox.pdmodel.interactive.measurement.PDRectlinearMeasureDictionary;
import org.sejda.sambox.pdmodel.interactive.viewerpreferences.PDViewerPreferences;

/* loaded from: org.sejda.sambox-3.0.24.jar:org/sejda/sambox/cos/COSName.class */
public final class COSName extends COSBase implements Comparable<COSName> {
    ...
    public static final COSName A = newCommonInstance(PDPageLabelRange.STYLE_LETTERS_UPPER);
    ...
    public static final COSName ANNOT = newCommonInstance(StandardStructureTypes.ANNOT);
    ...
    public static final COSName ART_BOX = newCommonInstance(PDViewerPreferences.BOUNDARY_ART_BOX);
    ...
    public static final COSName AUTHOR = newCommonInstance(PdfMetadataFields.AUTHOR);
    ...
    public static final COSName BLEED_BOX = newCommonInstance(PDViewerPreferences.BOUNDARY_BLEED_BOX);
    ...
    public static final COSName C = newCommonInstance(PDBorderEffectDictionary.STYLE_CLOUDY);
    ...
    public static final COSName CREATOR = newCommonInstance(PdfMetadataFields.CREATOR);
    public static final COSName CROP_BOX = newCommonInstance(PDViewerPreferences.BOUNDARY_CROP_BOX);
    public static final COSName CRYPT = newCommonInstance("Crypt");
    public static final COSName CS = newCommonInstance(OperatorName.STROKING_COLORSPACE);
    ...
    public static final COSName DOCUMENT = newCommonInstance(StandardStructureTypes.DOCUMENT);
    public static final COSName DOMAIN = newCommonInstance("Domain");
    public static final COSName DOS = newCommonInstance("DOS");
    public static final COSName DP = newCommonInstance(OperatorName.MARKED_CONTENT_POINT_WITH_PROPS);
    ...
    public static final COSName FORM = newCommonInstance(StandardStructureTypes.FORM);
    ...
    public static final COSName G = newCommonInstance(OperatorName.STROKING_COLOR_GRAY);
    public static final COSName GAMMA = newCommonInstance("Gamma");
    public static final COSName GROUP = newCommonInstance(PDAnnotationMarkup.RT_GROUP);
    public static final COSName GTS_PDFA1 = newCommonInstance("GTS_PDFA1");
    public static final COSName H = newCommonInstance(StandardStructureTypes.H);
    ...
    public static final COSName ID = newCommonInstance(OperatorName.BEGIN_INLINE_IMAGE_DATA);
    ...
    public static final COSName INDEX = newCommonInstance(StandardStructureTypes.INDEX);
    ...
    public static final COSName JAVA_SCRIPT = newCommonInstance(PDActionJavaScript.SUB_TYPE);
    ...
    public static final COSName K = newCommonInstance(OperatorName.STROKING_COLOR_CMYK);
    public static final COSName KEYWORDS = newCommonInstance(PdfMetadataFields.KEYWORDS);
    public static final COSName KIDS = newCommonInstance("Kids");
    public static final COSName L = newCommonInstance(StandardStructureTypes.L);
    ...
    public static final COSName M = newCommonInstance(OperatorName.SET_LINE_MITERLIMIT);
    ...
    public static final COSName MEDIA_BOX = newCommonInstance(PDViewerPreferences.BOUNDARY_MEDIA_BOX);
    public static final COSName MEASURE = newCommonInstance(PDMeasureDictionary.TYPE);
    ...
    public static final COSName N = newCommonInstance(PDAnnotationLink.HIGHLIGHT_MODE_NONE);
    ...
    public static final COSName NORMAL = newCommonInstance(PDLayoutAttributeObject.LINE_HEIGHT_NORMAL);
    public static final COSName NUMS = newCommonInstance("Nums");
    public static final COSName O = newCommonInstance(PDAnnotationLink.HIGHLIGHT_MODE_OUTLINE);
    ...
    public static final COSName POPUP = newCommonInstance(PDAnnotationPopup.SUB_TYPE);
    ...
    public static final COSName Q = newCommonInstance(OperatorName.RESTORE);
    ...
    public static final COSName RUN_LENGTH_DECODE_ABBREVIATION = newCommonInstance(PDRectlinearMeasureDictionary.SUBTYPE);
    ...
    public static final COSName STANDARD = newCommonInstance(StandardSecurityHandler.FILTER);
    ...
    public static final COSName SUBJECT = newCommonInstance(PdfMetadataFields.SUBJECT);
    ...
    public static final COSName T = newCommonInstance(PDNumberFormatDictionary.FRACTIONAL_DISPLAY_TRUNCATE);
    ...
    public static final COSName TITLE = newCommonInstance(PdfMetadataFields.TITLE);
    ...
    public static final COSName TR = newCommonInstance(StandardStructureTypes.TR);
    ...
    public static final COSName TRIM_BOX = newCommonInstance(PDViewerPreferences.BOUNDARY_TRIM_BOX);
    ...
    public static final COSName U = newCommonInstance(PDBorderStyleDictionary.STYLE_UNDERLINE);
    ...
    public static final COSName URI = newCommonInstance(PDActionURI.SUB_TYPE);
    ...
    public static final COSName W = newCommonInstance(OperatorName.CLIP_NON_ZERO);
    ...
    public static COSName getPDFName(String aName) {
        if (aName != null) {
            ...
            return (COSName) Objects.requireNonNullElseGet(cosName, () -> {
    ...
    public static COSName getCustom(String customName) {
        COSName cosName = CUSTOM_NAMES.get(customName);
        if (cosName == null) {
            COSName value = new COSName(customName);
