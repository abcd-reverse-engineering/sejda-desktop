...
public class PdfTextExtractor implements Closeable {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: org.sejda.model.exception.TaskExecutionException */
    public PdfTextExtractor(Charset encoding, OutputStream outputStream) throws TaskExecutionException, TaskException {
        try {
