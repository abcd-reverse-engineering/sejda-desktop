...
public class Type0SubsettableInUseFont extends SubsettableInUseFont {
    ...
    public void subset() {
        ...
        if (Objects.nonNull(subsettedStream)) {
            COSDictionary descriptor = this.descendant.getDictionaryObject(COSName.FONT_DESC, COSDictionary.class).duplicate();
            try {
                ...
                this.descendant.setItem(COSName.FONT_DESC, descriptor);
            } catch (IOException e) {
