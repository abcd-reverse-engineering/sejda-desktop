...
public class CombineReorderParameters extends BaseMergeParameters<MergeInput> {
   private @NotEmpty List<FileIndexAndPage> pages = new ArrayList();
   private @NotNull AcroFormPolicy acroFormPolicy;
   private @NotNull OutlinePolicy outlinePolicy;

   public CombineReorderParameters() {
      this.acroFormPolicy = AcroFormPolicy.MERGE_RENAMING_EXISTING_FIELDS;
