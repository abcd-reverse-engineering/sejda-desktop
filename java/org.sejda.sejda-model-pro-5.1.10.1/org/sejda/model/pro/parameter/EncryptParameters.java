...
public class EncryptParameters extends MultiplePdfSourceMultipleOutputParameters {
   ...
   private @NotNull PdfEncryption encryptionAlgorithm;
   ...
   public PdfVersion getMinRequiredPdfVersion() {
      return PdfVersion.getMax(new PdfVersion[]{super.getMinRequiredPdfVersion(), this.encryptionAlgorithm.getMinVersion()});
   }
   ...
   public boolean equals(Object other) {
      if (this == other) {
         return true;
      } else if (other instanceof EncryptParameters) {
