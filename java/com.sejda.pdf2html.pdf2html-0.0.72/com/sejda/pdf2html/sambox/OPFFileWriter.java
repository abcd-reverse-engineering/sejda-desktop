...
public class OPFFileWriter {
    ...
    public void write(final File out, final File bookFile, final File tocFile) {
        ...
        UnprefixedAttribute unprefixedAttribute = new UnprefixedAttribute("version", new Text("2.0"), new UnprefixedAttribute("unique-identifier", new Text("BookId"), Null$.MODULE$));
